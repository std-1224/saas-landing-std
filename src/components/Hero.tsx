      ...
      <div className="container relative">
        ...
        <div className="flex justify-center mt-8 ">
          <div className="inline-flex relative">
            <h1 className='text-7xl sm:text-9xl font-bold tracking-tightner text-center inline-flex'>Service <br /> is more</h1>
        ...
        <div className="flex justify-center mt-8">
          <button className='bg-[#5D2C84] text-white py-3 px-5 rounded-lg font-medium border-white border-2'>Get started</button>
        </div>
      </div>
    </div>
  )
